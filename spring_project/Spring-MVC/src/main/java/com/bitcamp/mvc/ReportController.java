...
import com.bitcamp.mvc.domain.RequestReport;
...
public class ReportController {
	...
	public String submit3(
				@ModelAttribute("report") RequestReport report,
				HttpServletRequest request
				) {
		
		System.out.println("학번 : " + report.getSno());
		System.out.println("이름 : " + report.getSname());
		System.out.println("리포트 파일 : " + report.getReport());
		...
		try {
			...
			System.out.println("파일저장완료 : "+fileName);
		} catch (Exception e) {
			e.printStackTrace();
		}	
