package day0909;
// Random 클래스
// Random은 정해진 규칙없이 무수히 많은 숫자들이
// 나열되어있고
// 그것을 우리가 하나씩 뽑는 개념인
// 난수를 담당하는 클래스로써,
// 우리가 랜덤함 숫자를 뽑을 수 있게 해준다.
// Scanner와 마찬가지로, java.util에 있는
// Random 클래스를 우리가 불러와야 정상적으로 사용을 할 수 있다.
...
public class Ex11Random {
    public static void main(String[] args) {
        ...
        // random은 내부적으로
        // 0부터 1사이의 무수한 실수를 뒤죽박죽순서로 가지고있다.
        ...
        // 그렇다면 만약 우리가
        // 0부터 특정값 -1 이 아닌
        // 1부터 특정값까지의 난수가 필요할 때에는 어떻게 해야할까?
        //양수만 나올 수 있따
        
        System.out.println("3. nextInt(MAX) + 1");
