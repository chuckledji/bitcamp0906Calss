...
//      자식 클래스 객체가 해당 메소드를 호출할 시 A의 메소드가 호출되야할까 B의 메소드가 호출되어야할까....?

// 단, 다른 클래스를 상속받는 부모 클래스를 상속받는 것은 문제가 없다!
public class Gorilla extends  Monkey{
//    public class Gorilla extends Animal, Monkey이건 안되고
//    public class Gorilla extends (Animal의 상속을 받는)Monkey 는 된다는것
