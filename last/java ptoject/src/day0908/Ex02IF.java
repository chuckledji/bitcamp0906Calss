...
// 조건문: 특정 조건을 만족시 코드블락을 실행
// 반복문: 특정 조건을 만족하는 동안 코드 블락을 반복
...
// 조건문 01
// If 조건문
// If 조건문 true/false가 결과값으로 나오는 코드, 즉 조건식을 실행시켜서
...
public class Ex02IF {
    public static void main(String[] args) {
        ...
        if (num > 0) {
            ...
            System.out.println("num2: " + num2);// 35부터 38중괄호 닫히기 전까지 유효
        }
        int num2 = 44;
