...
// 기네스북에 따르면 세계에서 가장 키가 컸던 사람의 키는 2.72m이었습니다.
// 기네스북에 따르면 세계에서 가장 몸무게가 무거웟던 사람의 모무게는 650킬로그램이었습니다.

// 만약 사용자가 잘못된 값을 입력할 경우, 추가적인 입력 없이
// "잘못된 입력을 감지하여 프로그램을 종료합니다." 라는
// 메세지가 출력되면서 프로그램이 종료하게 코드를 작성하시오
    ...
    public static void main(String[] args) {
        ...
        if (height > 0 && height <= HEIGHT_MAX) {
            ...
            if (weight > 0 && weight <= WEIGHT_MAX) {
                // 몸무게 올바른 값이므로 이름 입력 -> BMI계산 -> 비만도 결정 -> 결과 출력을 실행한다.
