...
public class Ex01For {
    public static void main(String[] args) {
        ...
        //   중첩되는 레벨에 따라 j,k순으로 들어가지만
        //   만약 익숙하지 않을 때에는 다른 이름을 사용하더라도 상관 없다.
        
        System.out.println("2. 제어변수 이름");
        for (int num = 1; num <=4; num ++) {
            System.out.println("num의 현잭값 " +num);
            
        }
        System.out.println("--------------------"); 
        
        //3. 우리가 지금은 제어변수의 변화식을 ++을 썼지만
        // 제어변수 안의 값을 변화시킬 수 있는 연산자 혹은 메소드는 뭐든 가능하다.
        ...
        //4. 제어변수의 초기화 혹은 반복 조건식에는 다른 변수를 사용할 수 없다.
        int start = 41;
        int end = 45;
       ...
       System.out.println("5.처음부타 false가 나오면?");
       for(int i = 0; i <0; i++){
           System.out.println("i의 현재값:" +i);
       }System.out.println("--------------------"); 
