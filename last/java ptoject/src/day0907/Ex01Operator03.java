...
public class Ex01Operator03 {
    public static void main(String[] args) {
        ...
        // 비교 연산자를 사용할때 주의할 점
        // 1. 어떤 값이 특정 범위에 속하는지 확인할 때에는
        // 값1 < 변수 < 값2 로 할 수 없다. (한번에 여러 연산자를 처리할 수 없다)
        // 0 < num1 < 10
        
        // 2. 다른 연산자들도 마찬가지이지만
        //    2글자 이상의 기호로 이루어져있을 경우, 기호 사이에 공백을 넣어선 안된다.
        //    0 < = 10 -> 에러
        //    0 <= 10  -> true
        
        // 3. 비교연산자는 참조형 데이터타입이 나오기 전부터 존재하는 개념이었다.
        //    그렇기 때문에 참조형 데이터타입의 값들을 비교할 때에는 비교연산자를 사용하면 부정확한 값이 나올 수 있다.
       ...
       // 그러므로 String타입의 변수 str1, str2, str3를 선언하고
       ...
       // 비교연산자를 사용하여 str1과 str2, str1과str3, str2와str3를 비교해보자
       ...
       // 참조형 데이터타입은, Stack 메모리 안에는 Heap메모리 주소값만 저장이 되고, 
       // 데이터타입의 실제 값은 해당 Heap 메모리 주소를 참조해서
       // Heap 메모리 안에 들어가야 확인이 가능하다.
       // 하지만, 비교 연산자의 경우, 그 메모리 주소값을 참조해서 Heap 영역 안의 
       // 실제 값을 확인하여 그 값을 비교하는 것이 아니라
       ...
       // 또한 메소드를 사용하면 대/소문자 구별 없이 같은 철자가 들어가 있는지도 비교가 가능하다.
