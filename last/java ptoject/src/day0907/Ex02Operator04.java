...
// ||: OR 연산자. 왼쪽과 오른쪽 중 한개라도 true이면  true가 결과값으로 나온다.
...
public class Ex02Operator04 {
     public static void main(String[] args) {
         ...
         //true에 노란줄이 나오는 이유는 앞에 false가 나옴으로써 
         // 뒤에 것까지 볼 필요 없이이미 결과값은 false라는 것을 알려주는 것.
         ...
         // 우리가 비교연산자에서
         // 안된다고 배웠던 범위를 체크하는 연산은 우리가 논리 연산자를 함께 써주면 된다.
         
         //예를 들어서, int 변수 num의 값이 0초과 10미만인지 확일할 땐
         // 우리가 && 연산자를 사용하면 된다!
