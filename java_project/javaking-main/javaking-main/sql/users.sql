...
insert into users values(users_seq.nextval, 'tName1', 't1', 't1', '서울특별시 강남구 비트캠프', '010-0101-1010', 'jkmanager@gmail.com');  
insert into users values(users_seq.nextval, 'tName2', 't2', 't2', '서울특별시 강남구 비트캠프', '010-0101-1010', 'jkmanager@gmail.com');  
